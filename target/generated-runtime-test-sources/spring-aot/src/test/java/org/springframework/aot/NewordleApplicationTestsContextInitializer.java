...
import com.newordle.newordle.NewordleApplication;
...
/**
 * AOT generated context for {@code NewordleApplicationTests}.
 */
public class NewordleApplicationTestsContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext context) {
    ...
    BeanDefinitionRegistrar.of("newordleApplication", NewordleApplication.class)
        .instanceSupplier(NewordleApplication::new).register(beanFactory);
    com.newordle.newordle.controllers.NewordleApplicationTestsContextInitializer.registerController(beanFactory);
    BeanDefinitionRegistrar.of("newordleService", NewordleService.class)
        .instanceSupplier(NewordleService::new).register(beanFactory);
    ...
    org.springframework.boot.autoconfigure.NewordleApplicationTestsContextInitializer.registerAutoConfigurationPackages_BasePackages(beanFactory);
    ...
    org.springframework.boot.autoconfigure.websocket.servlet.NewordleApplicationTestsContextInitializer.registerWebSocketServletAutoConfiguration_TomcatWebSocketConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.websocket.servlet.NewordleApplicationTestsContextInitializer.registerTomcatWebSocketConfiguration_websocketServletWebServerCustomizer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NewordleApplicationTestsContextInitializer.registerServletWebServerFactoryConfiguration_EmbeddedTomcat(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.NewordleApplicationTestsContextInitializer.registerEmbeddedTomcat_tomcatServletWebServerFactory(beanFactory);
    ...
    org.springframework.boot.context.properties.NewordleApplicationTestsContextInitializer.registerConfigurationPropertiesBinder_Factory(beanFactory);
    org.springframework.boot.context.properties.NewordleApplicationTestsContextInitializer.registerConfigurationPropertiesBinder(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NewordleApplicationTestsContextInitializer.registerDispatcherServletAutoConfiguration_DispatcherServletConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.NewordleApplicationTestsContextInitializer.registerDispatcherServletConfiguration_dispatcherServlet(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NewordleApplicationTestsContextInitializer.registerDispatcherServletAutoConfiguration_DispatcherServletRegistrationConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.NewordleApplicationTestsContextInitializer.registerDispatcherServletRegistrationConfiguration_dispatcherServletRegistration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.error.NewordleApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_WhitelabelErrorViewConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.NewordleApplicationTestsContextInitializer.registerWhitelabelErrorViewConfiguration_error(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.NewordleApplicationTestsContextInitializer.registerWhitelabelErrorViewConfiguration_beanNameViewResolver(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.NewordleApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_DefaultErrorViewResolverConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.NewordleApplicationTestsContextInitializer.registerDefaultErrorViewResolverConfiguration_conventionErrorViewResolver(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.error.NewordleApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_errorPageCustomizer(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.NewordleApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_preserveErrorControllerTargetClassPostProcessor(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.NewordleApplicationTestsContextInitializer.registerWebMvcAutoConfiguration_EnableWebMvcConfiguration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NewordleApplicationTestsContextInitializer.registerEnableWebMvcConfiguration_welcomePageHandlerMapping(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NewordleApplicationTestsContextInitializer.registerWebMvcAutoConfiguration_WebMvcAutoConfigurationAdapter(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jackson.NewordleApplicationTestsContextInitializer.registerJacksonAutoConfiguration_Jackson2ObjectMapperBuilderCustomizerConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NewordleApplicationTestsContextInitializer.registerJackson2ObjectMapperBuilderCustomizerConfiguration_standardJacksonObjectMapperBuilderCustomizer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jackson.NewordleApplicationTestsContextInitializer.registerJacksonAutoConfiguration_JacksonObjectMapperBuilderConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NewordleApplicationTestsContextInitializer.registerJacksonObjectMapperBuilderConfiguration_jacksonObjectMapperBuilder(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NewordleApplicationTestsContextInitializer.registerJacksonAutoConfiguration_ParameterNamesModuleConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NewordleApplicationTestsContextInitializer.registerParameterNamesModuleConfiguration_parameterNamesModule(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NewordleApplicationTestsContextInitializer.registerJacksonAutoConfiguration_JacksonObjectMapperConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NewordleApplicationTestsContextInitializer.registerJacksonObjectMapperConfiguration_jacksonObjectMapper(beanFactory);
    ...
    org.springframework.boot.autoconfigure.http.NewordleApplicationTestsContextInitializer.registerHttpMessageConvertersAutoConfiguration_StringHttpMessageConverterConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.http.NewordleApplicationTestsContextInitializer.registerStringHttpMessageConverterConfiguration_stringHttpMessageConverter(beanFactory);
    org.springframework.boot.autoconfigure.http.NewordleApplicationTestsContextInitializer.registerJacksonHttpMessageConvertersConfiguration_MappingJackson2HttpMessageConverterConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.http.NewordleApplicationTestsContextInitializer.registerMappingJackson2HttpMessageConverterConfiguration_mappingJackson2HttpMessageConverter(beanFactory);
    org.springframework.boot.autoconfigure.http.NewordleApplicationTestsContextInitializer.registerJacksonHttpMessageConvertersConfiguration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.mongo.NewordleApplicationTestsContextInitializer.registerMongoAutoConfiguration_MongoClientSettingsConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.mongo.NewordleApplicationTestsContextInitializer.registerMongoClientSettingsConfiguration_mongoClientSettings(beanFactory);
    org.springframework.boot.autoconfigure.mongo.NewordleApplicationTestsContextInitializer.registerMongoClientSettingsConfiguration_mongoPropertiesCustomizer(beanFactory);
    ...
    org.springframework.boot.sql.init.dependency.NewordleApplicationTestsContextInitializer.registerDatabaseInitializationDependencyConfigurer_DependsOnDatabaseInitializationPostProcessor(beanFactory);
    ...
    BeanDefinitionRegistrar.of("taskScheduler", ThreadPoolTaskScheduler.class).withFactoryMethod(TaskSchedulingAutoConfiguration.class, "taskScheduler", TaskSchedulerBuilder.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(TaskSchedulingAutoConfiguration.class).taskScheduler(attributes.get(0)))).register(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NewordleApplicationTestsContextInitializer.registerHttpEncodingAutoConfiguration_localeCharsetMappingsCustomizer(beanFactory);
