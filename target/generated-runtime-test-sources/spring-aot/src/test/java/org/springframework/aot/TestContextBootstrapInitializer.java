...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.newordle.newordle.NewordleApplicationTests", () -> new AotSpringBootConfigContextLoader(NewordleApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.newordle.newordle.NewordleApplicationTests", NewordleApplicationTestsContextInitializer.class);
    return entries;
  }
}
