...
public class ContextBootstrapInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  ...
  public void initialize(GenericApplicationContext context) {
    ...
    BeanDefinitionRegistrar.of("com.newordle.newordle.NewordleApplication", NewordleApplication.class)
        .instanceSupplier(NewordleApplication::new).register(beanFactory);
    com.newordle.newordle.controllers.ContextBootstrapInitializer.registerController(beanFactory);
    ...
    org.springframework.boot.autoconfigure.mongo.ContextBootstrapInitializer.registerMongoAutoConfiguration_MongoClientSettingsConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.mongo.ContextBootstrapInitializer.registerMongoClientSettingsConfiguration_mongoClientSettings(beanFactory);
    org.springframework.boot.autoconfigure.mongo.ContextBootstrapInitializer.registerMongoClientSettingsConfiguration_mongoPropertiesCustomizer(beanFactory);
